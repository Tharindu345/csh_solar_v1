...
import { mockServices, mockProjects, mockCustomers } from '../../data/mockData';
...
const Services: React.FC = () => {
  ...
  const servicesWithDetails = mockServices.map(service => {
  ...
  const filteredServices = servicesWithDetails.filter(service => {
  ...
  const upcomingServices = filteredServices.filter(s => s.status === 'Scheduled').length;
        ...
        <div className="bg-white p-4 md:p-6 rounded-lg shadow-sm border border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl md:text-2xl font-bold text-yellow-600">{upcomingServices}</p>
            </div>
        ...
        <div className="bg-white p-4 md:p-6 rounded-lg shadow-sm border border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl md:text-2xl font-bold text-blue-600">{inProgressServices}</p>
            </div>
        ...
        <div className="bg-white p-4 md:p-6 rounded-lg shadow-sm border border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl md:text-2xl font-bold text-green-600">{completedServices}</p>
            </div>
